...
public class PutProduitThread implements Runnable {
	...
	public PutProduitThread(Socket socketSOAP, String body) {
	...
	private void socketREST() {
		...
		try {
            ...
            wr.write(body);
            wr.flush();
            System.out.println("Requete PUT Produits/ envoyé au serveur REST");
