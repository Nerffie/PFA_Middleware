...
public class GetProduitsStockThread implements Runnable {
	...
	public GetProduitsStockThread(Socket socketSOAP) {
	...
	private void socketSOAP() {
		...
		try {
			...
			//out.close();
			//socketSOAP.close();
			System.out.println("Envoie de la réponse contenant le json Produits/Stock");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
