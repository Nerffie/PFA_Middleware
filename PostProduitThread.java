...
public class PostProduitThread implements Runnable {
	...
	public PostProduitThread(Socket socketSOAP, String body) {
	...
	private void socketSOAP() {
		...
		try {
			...
			out.flush();
			System.out.println("Envoie de la réponse contenant le json Produits/ ajouté");
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	private void socketREST() {
		...
		try {
            ...
            wr.write(body);
            wr.flush();
            System.out.println("Requete POST Produits/ envoyé au serveur REST");
